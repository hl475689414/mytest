...
/**
 * <b>AbstractWxMsgController.java</b></br>
 * 
 * <pre>
 ...
 * @date Apr 27, 2018 10:56:45 PM
 * @since JDK 1.8
 */
@Controller
public abstract class AbstractWxMsgController extends AbstractJiajiaoBaseWxController {
	
	private final static Logger logger = LoggerFactory.getLogger(AbstractWxMsgController.class);
...
//	private InMsg  inMsg	= null;            // 本次请求 xml 解析后的 InMsg 对象
	...
	public void index() {
		...
		logger.debug("从微信公账号接收到的消息:[{}]",getInMsgXml());
		...
		else if (msg instanceof InSpeechRecognitionResults)  // update by unas at 2016-1-29,
